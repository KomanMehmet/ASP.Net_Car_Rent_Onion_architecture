using CarRent.Dto.LocationDtos;
    ...
    public class AdminLocationController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if(token != null)
            {
                ...
                var responseMessage = await client.GetAsync("https://localhost:7197/api/Locations");//client aracılığıyla api'daki methodlara erişmemizi sağlıyor.
        ...
        public async Task<IActionResult> CreateLocation(CreateLocationDto createLocationDto)
        {
            ...
            var respoenseMessage = await client.PostAsync("https://localhost:7197/api/Locations", content);
        ...
        public async Task<IActionResult> RemoveLocation(int id)
        {
            ...
            var responseMessage = await client.DeleteAsync($"https://localhost:7197/api/Locations?id=" + id);
        ...
        public async Task<IActionResult> UpdateLocation(int id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:7197/api/Locations/{id}");
        ...
        public async Task<IActionResult> UpdateLocation(UpdateLocationDto updateLocationDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7197/api/Locations", content);
